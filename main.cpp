...
printf("-->Enter C for stop blue car:\n");
printf("-->Enter D for start blue car:\n");
printf("-->Enter E for stop the bus:\n");
printf("-->Enter F for start the bus:\n");
printf("-->Enter G for stop truck:\n");
printf("-->Enter H for start truck:\n\n");

printf("-->Enter I for stop the big ship:\n");
printf("-->Enter J for start the big ship:\n");
printf("-->Enter K for stop  ship2:\n");
printf("-->Enter L for start ship2:\n");
printf("-->Enter M for stop  ship3:\n");
printf("-->Enter N for start ship3:\n\n");


printf("-->Enter O for start cloud 1:\n");
printf("-->Enter P for stop the cloud 1:\n");
printf("-->Enter Q for start the cloud 2:\n");
printf("-->Enter R for stop the cloud 2:\n");
printf("-->Enter S for start the cloud 3:\n");
printf("-->Enter T for stop the cloud 3:\n\n");

printf("-->Enter U for stop the plane :\n");
printf("-->Enter V for start the plane:\n\n");

printf("-->Enter W for Midnight:\n");
printf("-->Enter X for Day rain:\n\n");

printf("-->Enter Y for stop the sun:\n");
printf("-->Enter Z for start the sun:\n\n");

printf("-->Enter 1 for Day view:\n");
glutInit(&argc, argv);
